...
keymap.set("i", "<C-j>", "<Esc>:m .+1<CR>==gi", { desc = "Move line down" })

-- Insert mode: Move current line up
keymap.set("i", "<C-k>", "<Esc>:m .-2<CR>==gi", { desc = "Move line up" })
...
keymap.set("n", "<C-p>", ":BufferLineMovePrev<Return>", opts)
keymap.set("n", "<C-f>", ":BufferLineMoveNext<Return>", opts)
-- Split window
...
keymap.set("n", "sc", ":q<CR>", { desc = "Close current window" })
